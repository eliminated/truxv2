...
CREATE TABLE IF NOT EXISTS users (
  ...
  notify_post_quotes TINYINT(1) NOT NULL DEFAULT 1,
  ...
  ui_performance_mode VARCHAR(16) NOT NULL DEFAULT 'full',
...
CREATE TABLE IF NOT EXISTS linked_accounts (
  ...
  KEY idx_linked_accounts_user_email (user_id, provider_email),
  KEY idx_linked_accounts_provider_email (provider, provider_email),
